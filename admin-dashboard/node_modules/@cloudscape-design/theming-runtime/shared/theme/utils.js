...
export function getThemeMode(theme, token) {
    var _a;
    var modeId = theme.tokenModeMap[token];
    return (_a = theme.modes[modeId]) !== null && _a !== void 0 ? _a : null;
}
export function getThemeModeByState(theme, stateId) {
    var _a;
    return (_a = Object.values(theme.modes).find(function (mode) { return mode.states[stateId]; })) !== null && _a !== void 0 ? _a : null;
}
export function getModeState(mode, inherited) {
...
export function getInheritedState(context) {
    var _a, _b;
    return (_b = (_a = context.inheritsMode) !== null && _a !== void 0 ? _a : context.defaultMode) !== null && _b !== void 0 ? _b : null;
}
