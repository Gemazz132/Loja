...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_root_1i2wg_6k6mx_161:not(#\9) {
...
.awsui_dismiss-button_1i2wg_6k6mx_193:not(#\9) {
...
body[data-awsui-focus-visible=true] .awsui_dismiss-button_1i2wg_6k6mx_193:not(#\9):focus {
  position: relative;
}
body[data-awsui-focus-visible=true] .awsui_dismiss-button_1i2wg_6k6mx_193:not(#\9):focus {
...
body[data-awsui-focus-visible=true] .awsui_dismiss-button_1i2wg_6k6mx_193:not(#\9):focus::before {
  content: " ";
  display: block;
  position: absolute;
...
.awsui_dismiss-button_1i2wg_6k6mx_193:not(#\9):focus {
  outline: none;
  text-decoration: none;
}
.awsui_dismiss-button_1i2wg_6k6mx_193:not(#\9):hover {
  color: var(--awsui-token-style-dismiss-color-hover-6b9ypa, var(--color-text-button-inline-icon-hover-rbyzfc, #002b66));
}
.awsui_dismiss-button-inline_1i2wg_6k6mx_234:not(#\9) {
  padding-inline: 0;
  display: flex;
  align-items: center;
  align-self: center;
}
.awsui-one-theme .awsui_dismiss-button_1i2wg_6k6mx_193:not(#\9):not(.awsui_dismiss-button-inline_1i2wg_6k6mx_234) {
  padding-block-start: 1px;
}

.awsui_icon_1i2wg_6k6mx_244:not(#\9) {
  padding-inline-end: var(--space-xs-ymlm0b, 8px);
  align-self: flex-start;
  display: flex;
  flex-shrink: 0;
}
.awsui_icon-inline_1i2wg_6k6mx_250:not(#\9) {
  padding-inline-end: var(--space-xxs-hwfkai, 4px);
  align-self: center;
}

.awsui_token-normal_1i2wg_6k6mx_255:not(#\9) {
  block-size: 100%;
  display: flex;
...
.awsui_token-inline_1i2wg_6k6mx_262:not(#\9) {
  display: inline-flex;
  max-inline-size: 100%;
}
body[data-awsui-focus-visible=true] .awsui_token-inline_1i2wg_6k6mx_262:not(#\9):focus {
  position: relative;
}
body[data-awsui-focus-visible=true] .awsui_token-inline_1i2wg_6k6mx_262:not(#\9):focus {
  outline: 2px dotted transparent;
...
body[data-awsui-focus-visible=true] .awsui_token-inline_1i2wg_6k6mx_262:not(#\9):focus::before {
  content: " ";
  display: block;
  position: absolute;
  inset-inline-start: calc(-1 * 0px);
...
.awsui_token-option-inline_1i2wg_6k6mx_288:not(#\9) {
  max-block-size: 20px;
}

.awsui_token-box_1i2wg_6k6mx_292:not(#\9) {
  position: relative;
  block-size: 100%;
...
.awsui_token-box-without-dismiss_1i2wg_6k6mx_311:not(#\9) {
  padding-inline-end: var(--space-field-horizontal-0aq2ch, 12px);
}

.awsui_token-box-inline_1i2wg_6k6mx_315:not(#\9) {
  position: relative;
  block-size: 20px;
  max-block-size: 20px;
  ...
  align-items: center;
  background: var(--awsui-token-style-background-default-6b9ypa, var(--color-background-item-selected-9gppru, #f0fbff));
  border-start-start-radius: var(--border-radius-token-inline-tio0a0, 4px);
  border-start-end-radius: var(--border-radius-token-inline-tio0a0, 4px);
  border-end-start-radius: var(--border-radius-token-inline-tio0a0, 4px);
  border-end-end-radius: var(--border-radius-token-inline-tio0a0, 4px);
  color: var(--color-text-body-default-vvtq8u, #0f141a);
  box-sizing: border-box;
  max-inline-size: 100%;
}

.awsui_disable-padding_1i2wg_6k6mx_335:not(#\9) {
...
.awsui_token-box-readonly_1i2wg_6k6mx_342 > .awsui_dismiss-button_1i2wg_6k6mx_193:not(#\9),
.awsui_token-box-disabled_1i2wg_6k6mx_343 > .awsui_dismiss-button_1i2wg_6k6mx_193:not(#\9) {
  cursor: initial;
  pointer-events: none;
}

.awsui_token-box-readonly_1i2wg_6k6mx_342:not(#\9) {
...
.awsui_token-box-disabled_1i2wg_6k6mx_343:not(#\9) {
  pointer-events: none;
