...
@layer awsui-base-theme {
  body {
    ...
    --color-background-toggle-button-normal-default-ipnqr5:var(--color-background-button-normal-default-7f99mv);
    --color-background-toggle-button-normal-hover-0r2lj4:var(--color-background-button-normal-hover-53op9s);
    ...
    --color-background-code-editor-gutter-active-line-error-4tea3r:var(--color-text-status-error-bwp1cm);
    ...
    --color-background-side-navigation-item-active-collapsed-ceubmy:var(--color-background-control-checked-ka7kc2);
    ...
    --color-background-slider-handle-error-default-lkvr7g:var(--color-text-status-error-bwp1cm);
    --color-background-slider-handle-error-active-juz76l:var(--color-text-status-error-bwp1cm);
    --color-background-slider-handle-warning-default-bxdwem:var(--color-text-status-warning-ylxn5k);
    --color-background-slider-handle-warning-active-g2mc01:var(--color-text-status-warning-ylxn5k);
    --color-background-slider-range-error-default-3mwwq7:var(--color-text-status-error-bwp1cm);
    --color-background-slider-range-error-active-jkg6yr:var(--color-text-status-error-bwp1cm);
    --color-background-slider-range-warning-default-enwb8c:var(--color-text-status-warning-ylxn5k);
    --color-background-slider-range-warning-active-7pdaif:var(--color-text-status-warning-ylxn5k);
    ...
    --color-border-toggle-button-normal-default-13wcrj:var(--color-border-button-normal-default-glqfp1);
    --color-border-toggle-button-normal-hover-0gzb6n:var(--color-border-button-normal-hover-6a2tdq);
    ...
    --color-text-side-navigation-item-active-collapsed-kwpe9n:var(--color-text-inverted-4v4dmq);
    --color-text-side-navigation-item-default-1vcdej:var(--color-text-body-secondary-yna5sb);
    ...
    --color-border-divider-table-group-l55omi:var(--color-neutral-500-8van0b);
    ...
    --color-border-segment-wrapper-mvxnza:var(--color-border-input-default-317xk5);
    ...
    --color-text-calendar-date-selected-m18pgv:var(--color-background-control-default-4jb21l);
    ...
    --color-border-expandable-section-default-inl8g4:var(--color-border-divider-default-nr68jt);
    ...
    --color-text-status-error-bwp1cm:var(--color-error-600-mdn3ng);
    --color-text-status-inactive-gy7337:var(--color-neutral-600-fln1ww);
    --color-text-status-info-2ftgrk:var(--color-info-600-un21zh);
    --color-text-status-success-r9s7ha:var(--color-success-600-g7hz2i);
    --color-text-status-warning-ylxn5k:var(--color-warning-900-kpxt8c);
    ...
    --color-background-skeleton-sjxg4n:var(--color-neutral-250-vs1is4);
    ...
    --color-background-badge-grey-ipi6oq:var(--color-background-notification-grey-x3vul6);
    ...
    --color-text-badge-grey-5u533n:var(--color-text-notification-default-1iey72);
    --color-text-badge-green-xkzw5d:var(--color-text-notification-default-1iey72);
    --color-text-badge-blue-cq2uzn:var(--color-text-notification-default-1iey72);
    --color-text-badge-red-60jprp:var(--color-text-notification-default-1iey72);
    --color-background-code-view-6vvqfk:#f8f8f8;
    ...
    --font-size-expandable-heading-duh2ta:var(--font-size-heading-s-zp08en);
  ...
  @media not print {
    .awsui-dark-mode:not(#\9) {
      ...
      --color-border-divider-table-group-l55omi:var(--color-neutral-600-fln1ww);
      ...
      --color-text-status-error-bwp1cm:var(--color-error-400-c0knb8);
      --color-text-status-inactive-gy7337:var(--color-neutral-450-kn0235);
      --color-text-status-info-2ftgrk:var(--color-info-400-674xac);
      --color-text-status-success-r9s7ha:var(--color-success-500-hhxb4g);
      --color-text-status-warning-ylxn5k:var(--color-warning-500-zidhub);
      ...
      --color-background-skeleton-sjxg4n:var(--color-neutral-750-pi9qqd);
      --color-background-skeleton-wave-1dy97d:var(--color-neutral-700-qw8ats);
      --color-background-code-view-6vvqfk:#282c34;
  ...
  .awsui-context-flashbar:not(#\9) {
    ...
    --color-text-status-error-bwp1cm:var(--color-text-notification-default-1iey72);
    --color-text-status-info-2ftgrk:var(--color-text-notification-default-1iey72);
    --color-text-status-success-r9s7ha:var(--color-text-notification-default-1iey72);
  ...
  .awsui-context-flashbar-warning:not(#\9) {
    ...
    --color-text-status-warning-ylxn5k:var(--color-text-notification-yellow-vjtdxk);
  ...
  .awsui-context-alert:not(#\9) {
    ...
    --font-size-expandable-heading-duh2ta:14px;
    --color-background-toggle-button-normal-default-ipnqr5:var(--color-background-button-normal-default-7f99mv);
    --color-background-toggle-button-normal-hover-0r2lj4:var(--color-background-button-normal-hover-53op9s);
    --color-background-button-primary-default-vdt0fu:var(--color-border-button-normal-default-glqfp1);
    --color-background-button-primary-hover-mo85i6:var(--color-border-button-normal-hover-6a2tdq);
