...
import { InternalFilteringOption, InternalFilteringProperty, InternalFreeTextFiltering } from './internal-interfaces.js';
...
export declare function PropertyInput({
  property,
  onChangePropertyKey,
  asyncProps,
  filteringProperties,
...
export declare function OperatorInput({
  property,
  operator,
  onChangeOperator,
  i18nStrings,
  freeTextFiltering,
  triggerVariant
}: OperatorInputProps): JSX.Element;
