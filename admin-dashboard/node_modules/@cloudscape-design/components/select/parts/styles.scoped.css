...
.awsui_placeholder_dwuol_1pf5a_145:not(#\9) {
  color: var(--color-text-input-placeholder-dclg8u, #656871);
  font-style: italic;
  -webkit-user-select: none;
          user-select: none;
}
.awsui_placeholder_dwuol_1pf5a_145.awsui_disabled_dwuol_1pf5a_150:not(#\9) {
  color: var(--color-text-input-placeholder-disabled-wg87og, #b4b4bb);
}

.awsui_item_dwuol_1pf5a_154:not(#\9) {
  display: flex;
  align-items: center;
}
.awsui_item_dwuol_1pf5a_154 > .awsui_checkbox_dwuol_1pf5a_158:not(#\9) {
  position: relative;
...
.awsui_option-group_dwuol_1pf5a_167:not(#\9):not(:first-child) {
  margin-block-start: calc(-1 * var(--border-item-width-miijiw, 2px));
}

.awsui_filter_dwuol_1pf5a_171:not(#\9) {
  z-index: 4;
  flex-shrink: 0;
}

.awsui_trigger_dwuol_1pf5a_176:not(#\9) {
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
}

.awsui_layout-strut_dwuol_1pf5a_182:not(#\9) {
  inline-size: 100%;
  position: relative;
  transform: translate3d(0, 0, 0);
}

.awsui_list-bottom_dwuol_1pf5a_188:not(#\9) {
  /* used in unit-tests */
}

.awsui_selected-icon_dwuol_1pf5a_192:not(#\9) {
  color: var(--color-item-selected-72rnwy, #006ce0);
  padding-inline-start: var(--space-xs-ymlm0b, 8px);
}

.awsui_show-label-tag_dwuol_1pf5a_197 > .awsui_selected-icon_dwuol_1pf5a_192:not(#\9) {
  padding-inline-start: var(--space-scaled-s-8ozaad, 12px);
}

.awsui_inline-token-trigger_dwuol_1pf5a_201:not(#\9) {
  display: flex;
  flex-wrap: nowrap;
...
.awsui_inline-token-list_dwuol_1pf5a_208:not(#\9) {
  display: flex;
  flex-wrap: nowrap;
  align-items: center;
...
.awsui_inline-token-list_dwuol_1pf5a_208:not(#\9):dir(rtl) {
  mask-image: linear-gradient(-270deg, transparent, white 20px, white);
}

.awsui_inline-token-hidden-placeholder_dwuol_1pf5a_222:not(#\9) {
  position: absolute !important;
  inset-block-start: -9999px !important;
  inset-inline-start: -9999px !important;
}

.awsui_inline-token-counter_dwuol_1pf5a_228:not(#\9) {
  white-space: nowrap;
}

.awsui_inline-label-trigger-wrapper_dwuol_1pf5a_232:not(#\9) {
  margin-block-start: -7px;
}

.awsui_inline-label-wrapper_dwuol_1pf5a_236:not(#\9) {
  margin-block-start: calc(var(--space-scaled-xs-xwoogq, 8px) * -1);
}

.awsui_inline-label_dwuol_1pf5a_232:not(#\9) {
...
.awsui_inline-label-disabled_dwuol_1pf5a_261:not(#\9) {
...
.awsui_inline-label-inline-tokens_dwuol_1pf5a_265:not(#\9) {
  padding-block-end: 0;
  transform: translateY(-1.5px);
}

.awsui_disabled-reason-tooltip_dwuol_1pf5a_270:not(#\9) {
