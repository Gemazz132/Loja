...
export declare function useMultiselect({
  ...
  getMenuProps: () => {
    ...
    onFocus?: import("../types/events").NonCancelableEventHandler | undefined;
    onBlur?: import("../types/events").NonCancelableEventHandler<{
      relatedTarget: Node | null;
    }> | undefined;
    onKeyDown?: import("../types/events").CancelableEventHandler<import("../types/events").BaseKeyDetail> | undefined;
  ...
  getTokenProps: () => {
    onDismiss: import("../types/events").NonCancelableEventHandler<TokenGroupProps.DismissDetail>;
  };
  getDropdownProps: () => {
    onMouseDown: (event: React.MouseEvent) => void;
    onFocus?: import("../types/events").NonCancelableEventHandler<Pick<React.FocusEvent, "target" | "relatedTarget">> | undefined;
    onBlur?: import("../types/events").NonCancelableEventHandler<Pick<React.FocusEvent, "target" | "relatedTarget">> | undefined;
